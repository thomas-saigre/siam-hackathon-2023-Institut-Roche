...
load brca_mRNA_100patients.mat
...
load brca_mRNA_patients_BayNet_n20_deg2_eps0_seed_11.mat
BayNet = M_d_1(A, A_1)

load brca_mRNA_patients_embedding_dim128_gen_dim256_dis_dim256_l2scale1e-06_batch_size500_epochs500.mat
CTGAN = M_d_1(A, A_1)

load syntheticData_mixedNetwork_test_fast_root_index_2.mat
MIIC = M_d_1(A, A_1)
...
load brca_mRNA_patients_PrivBayes_n20_deg2_eps1_seed_4.mat
...
load brca_mRNA_100patients_iteration_7_.mat
