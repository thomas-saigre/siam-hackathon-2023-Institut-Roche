...
data_1 = readtable('brca_mRNA_100patients.csv');
data_2 = readtable('Synthpop\brca_mRNA_100patients_iteration_7_.csv');
...
save brca_mRNA_100patients_iteration_7_ A_1
A = A(1:m_original, :);
save brca_mRNA_100patients A
